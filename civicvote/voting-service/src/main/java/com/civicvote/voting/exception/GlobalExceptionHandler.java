...
import com.civicvote.voting.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAlreadyVoted(UserAlreadyVotedException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleElectionNotActive(ElectionNotActiveException ex) {
        ErrorResponse error = new ErrorResponse(
